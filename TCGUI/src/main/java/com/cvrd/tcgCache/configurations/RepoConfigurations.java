...
import com.cvrd.tcgCache.rowMappers.*;
...
public class RepoConfigurations {
    ...
    public TableService<Category> categoryService() {
        ...
        return new SQLiteTableService<>("Categories",columns,"categoryId", new CategoryMapper());
    }
    ...
    public TableService<Condition> conditionService() {
        ...
        return new SQLiteTableService<>("Conditions",columns,"conditionId", new ConditionMapper());
    }
    ...
    public TableService<Group> groupService() {
        ...
        return new SQLiteTableService<>("Groups",columns,"groupId", new GroupMapper());
    }
    ...
    public TableService<Language> languageService() {
        ...
        columns.add(new Triplet<>("name", "text", ""));
        columns.add(new Triplet<>("abbr", "text", ""));
        return new SQLiteTableService<>("Languages",columns, "languageId", new LanguageMapper());
    }
    ...
    public TableService<Print> printService() {
        ...
        columns.add(new Triplet<>("name", "text", ""));
        columns.add(new Triplet<>("displayOrder", "integer", ""));
        return new SQLiteTableService<>("Prints",columns, "printingId", new PrintMapper());
    }
    ...
    public TableService<Product> productService() {
        ...
        return new SQLiteTableService<>("Products",columns, "productId", new ProductMapper());
    }
    ...
    public TableService<Sku> skuService() {
        ...
        return new SQLiteTableService<>("Skus",columns, "skuId", new SkuMapper());
    }
    ...
    public TableService<SkuPrice> skuPriceService() {
        ...
        return new SQLiteTableService<>("SkuPrices",columns, "skuId", new SkuPriceMapper());
    }
}
