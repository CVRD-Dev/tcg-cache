...
from peewee import Model, CharField, IntegerField, BooleanField, ForeignKeyField, PrimaryKeyField, DecimalField
...
class SkuPrice(Model):
    ...
    lowPrice = DecimalField(null=True)
    marketPrice = DecimalField(null=True) 
